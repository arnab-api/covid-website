        ...
        <section>
        {
            loading ? (
                ...
                <>
                    ...
                    <Flex wrap="wrap" width="90%" justify="center" align="center" fontSize="11px">
                        <Flex wrap="wrap" width="45%" justify="center" align="center" fontSize="11px">
                                <Tooltip__color_table content="" direction="top">
                                    <svg width="40" height="10">
                                        ...
                                        />
                                    </svg> <strong class="unselectable">&nbsp;Trivial: {distDistribution[0]} Districts</strong>
                                ...
                                {/* &nbsp; &nbsp; &nbsp; */}
                                    ...
                                    <svg width="40" height="10">
                                        ...
                                        />
                                    </svg> <strong class="unselectable">&nbsp;Community Spread: {distDistribution[1]} Districts</strong>
                        ...
                        <Flex wrap="wrap" width="45%" justify="center" align="center" fontSize="11px">
                                <Tooltip__color_table content="" direction="top">
                                    ...
                                    <svg width="40" height="10">
                                        ...
                                        />
                                    </svg> <strong class="unselectable">&nbsp;Accelerated Spread: {distDistribution[2]} Districts</strong>
                                ...
                                <br/>
                                    ...
                                    <svg width="40" height="10">
                                        ...
                                        />
                                    </svg> <strong class="unselectable">&nbsp;Tipping Point: {distDistribution[3]} Districts</strong>
                                </Tooltip__color_table>
                        </Flex>
                    </Flex>
                    </div>
