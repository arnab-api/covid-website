...
export const DifferentRiskMaps__formulae = ({
    ...
    const [riskmap_formulae_arr, setRiskMap_formulae] = useState([]);
                            ...
                            .then((response) => {
                                ...
                                axios.get("/api/heat_map_array_tpr")
                                    .then((response) => {
                                        ...
                                        axios.get("/api/heat_map_array_formulae")
                                        .then((response) => {
                                            console.log("<<FORMULAE>> heat_map array >>> ", response.data, response.data.length);
    ...
    const handleSliderValueChage = (event, value) => {
        ...
        setHeatMap_formulae(riskmap_formulae_arr[value+7].heat_map)
        ...
        <section>
            {
                loading ? (
                    ...
                    {/* <Flex wrap="wrap" width="100%" height="30px" justify="center" align="center"> */}
                        ...
                        {/* <br/> */}
                        <SimpleGrid columns={5} spacing={1} style={{width:"100%"}}>
                            ...
                            <div className={styles.mapContainer} align="center" justify="center">
                                <MapChart_comparison heatmap={heatmap_formulae} isMethod={true} modelName={"New Approach"} bins={[Math.exp(3), Math.exp(5), Math.exp(7)]}/>
                                {/* New Approach */}
                            </div>
                            <div className={styles.mapContainer} align="center" justify="center">
